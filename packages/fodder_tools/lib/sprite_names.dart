...
final pstuffDatBriefing = <int, S>{
  ...
  0x03:
      Sfv('font_light_blue', 0xf0, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789\'.', [
        F(32320, 16, 16),
        F(32328, 16, 16),
        F(32336, 16, 16),
        F(32344, 16, 16),
...
final rankfontDatService = <int, S>{
  ...
  0x04: Sf(
    ...
    16,
    15,
    'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789()-?/:;"+=*&%\\\$#@ abcdefghijklmnopqr',
    [
      9920,
      9928,
      9936,
...
final armyDatIngame = <int, S>{
  ...
  0xd5: S('unused_squares_d5', 0xa0, 16, 14, [40448, 40456, 40464]),
  ...
  0xd7: S('rocket_s', 0xa0, 16, 14, [13448]),
  0xd8: S('rocket_sw', 0xa0, 16, 14, [13456]),
  0xd9: S('rocket_w', 0xa0, 16, 14, [13464]),
  0xda: S('rocket_nw', 0xa0, 16, 14, [13472]),
  0xdb: S('rocket_n', 0xa0, 16, 14, [20224]),
  0xdc: S('rocket_ne', 0xa0, 16, 14, [20232]),
  0xdd: S('rocket_e', 0xa0, 16, 14, [20240]),
  0xde: S('rocket_se', 0xa0, 16, 14, [20248]),
  0xef: S('civilian_panic_s', 0xa0, 16, 14, [44928, 44936, 44944]),
  0xf0: S('civilian_panic_sw', 0xa0, 16, 14, [44952, 47040, 47048]),
  0xf1: S('civilian_panic_w', 0xa0, 16, 14, [47056, 47064, 47072]),
  0xf2: S('civilian_panic_nw', 0xa0, 16, 14, [47080, 47088, 47096]),
  0xf3: S('civilian_panic_n', 0xa0, 16, 14, [47104, 47112, 47120]),
  0xf4: S('civilian_panic_ne', 0xa0, 16, 14, [47128, 47136, 47144]),
  0xf5: S('civilian_panic_e', 0xa0, 16, 14, [47152, 47160, 47168]),
  0xf6: S('civilian_panic_se', 0xa0, 16, 14, [47176, 47184, 47192]),
  0xf7: S('civilian_walk_s', 0xa0, 16, 14, [49280, 49288, 49296]),
  0xf8: S('civilian_walk_sw', 0xa0, 16, 14, [49304, 49312, 49320]),
  0xf9: S('civilian_walk_w', 0xa0, 16, 14, [49328, 49336, 49344]),
  0xfa: S('civilian_walk_nw', 0xa0, 16, 14, [49352, 49360, 49368]),
  0xfb: S('civilian_walk_n', 0xa0, 16, 14, [49376, 49384, 49392]),
  0xfc: S('civilian_walk_ne', 0xa0, 16, 14, [49400, 49408, 49416]),
  0xfd: S('civilian_walk_e', 0xa0, 16, 14, [49424, 49432, 51520]),
  0xfe: S('civilian_walk_se', 0xa0, 16, 14, [51528, 51536, 51544]),
  0xff: S('death_ash_pile', 0xa0, 16, 14, [51552, 49288, 51560]),
  0x100: S('death_gibbing', 0xa0, 16, 14, [
    38080,
    38088,
    38096,
    38104,
  ...
  0x101: S('death_gibbing_pre', 0xa0, 16, 14, [35960]),
  0x102: S('effect_explosion_dirt', 0xa0, 16, 14, [
    51584,
    51592,
    51600,
    51608,
  ...
  0x103: S('effect_water_splash', 0xa0, 16, 14, [35968, 35976, 35984]),
  0x104: S('gib_debris', 0xa0, 16, 14, [42624]),
  0x105: S('gib_arm', 0xa0, 16, 14, [42640]),
  0x106: S('gib_torso', 0xa0, 16, 14, [42648]),
  0x107: S('gib_leg', 0xa0, 16, 14, [42656]),
  0x108: S('effect_blood_pool', 0xa0, 16, 14, [44800, 44808, 44816, 44824]),
};
