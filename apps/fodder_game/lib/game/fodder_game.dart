...
class FodderGame extends FlameGame
  ...
  /// Shared copt sprite atlas (bullets, environment, rank icons, etc.).
  ...
  /// The shared copt sprite atlas (bullets, environment, rank icons, etc.).
  SpriteAtlas get coptAtlas => _coptAtlas;
